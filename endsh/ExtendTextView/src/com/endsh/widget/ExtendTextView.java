...
import com.endsh.R;
import com.endsh.internal.util.FastMath;
import com.endsh.internal.widget.EditableInputConnection;
import com.endsh.text.BoringLayout;
import com.endsh.text.DynamicLayout;
import com.endsh.text.GraphicsOperations;
import com.endsh.text.Layout;
import com.endsh.text.Selection;
import com.endsh.text.SpannableStringBuilder;
import com.endsh.text.StaticLayout;
import com.endsh.text.TextUtils;
import com.endsh.text.method.LinkMovementMethod;
import com.endsh.text.method.MovementMethod;
import com.endsh.text.style.ViewSpan;
import com.endsh.text.util.Linkify;

public class ExtendTextView extends ViewGroup implements ViewTreeObserver.OnPreDrawListener {
	private static final String LOG_TAG = "ExtendTextView";
    ...
    public interface OnEditorActionListener {
        boolean onEditorAction(ExtendTextView v, int actionId, KeyEvent event);
    }
    ...
    public ExtendTextView(Context context,
        ...
        TypedArray a =
            context.obtainStyledAttributes(
                attrs, R.styleable.ExtendTextView, defStyle, 0);
        ...
        int ap = a.getResourceId(R.styleable.ExtendTextView_android_textAppearance, -1);
        if (ap != -1) {
        ...
        if (appearance != null) {
            ...
            for (int i = 0; i < n; i++) {
                ...
                switch (attr) {
                case R.styleable.TextAppearance_android_textColorHighlight:
                ...
                case R.styleable.TextAppearance_android_textColorHint:
                    textColorHint = appearance.getColorStateList(attr);
                    break;

                case R.styleable.TextAppearance_android_textColorLink:
        ...
        Log.e(LOG_TAG, n + " inedx count");
        for (int i = 0; i < n; i++) {
            int attr = a.getIndex(i);

            switch (attr) {
            case R.styleable.ExtendTextView_android_editable:
                editable = a.getBoolean(attr, editable);
                break;

            case R.styleable.ExtendTextView_android_inputMethod:
                inputMethod = a.getText(attr);
                break;

            case R.styleable.ExtendTextView_android_numeric:
                numeric = a.getInt(attr, numeric);
                break;

            case R.styleable.ExtendTextView_android_digits:
                digits = a.getText(attr);
                break;

            case R.styleable.ExtendTextView_android_phoneNumber:
                phone = a.getBoolean(attr, phone);
                break;

            case R.styleable.ExtendTextView_android_autoText:
                autotext = a.getBoolean(attr, autotext);
                break;

            case R.styleable.ExtendTextView_android_capitalize:
                autocap = a.getInt(attr, autocap);
                break;

            case R.styleable.ExtendTextView_android_bufferType:
                buffertype = a.getInt(attr, buffertype);
                break;

            case R.styleable.ExtendTextView_android_selectAllOnFocus:
                selectallonfocus = a.getBoolean(attr, selectallonfocus);
                break;

            case R.styleable.ExtendTextView_android_autoLink:
                mAutoLinkMask = a.getInt(attr, 0);
                break;

            case R.styleable.ExtendTextView_android_linksClickable:
                mLinksClickable = a.getBoolean(attr, true);
                break;

            case R.styleable.ExtendTextView_android_drawableLeft:
                drawableLeft = a.getDrawable(attr);
                break;

            case R.styleable.ExtendTextView_android_drawableTop:
                drawableTop = a.getDrawable(attr);
                break;

            case R.styleable.ExtendTextView_android_drawableRight:
                drawableRight = a.getDrawable(attr);
                break;

            case R.styleable.ExtendTextView_android_drawableBottom:
                drawableBottom = a.getDrawable(attr);
                break;

            case R.styleable.ExtendTextView_android_drawablePadding:
                drawablePadding = a.getDimensionPixelSize(attr, drawablePadding);
                break;

            case R.styleable.ExtendTextView_android_maxLines:
                setMaxLines(a.getInt(attr, -1));
                break;

            case R.styleable.ExtendTextView_android_maxHeight:
                setMaxHeight(a.getDimensionPixelSize(attr, -1));
                break;

            case R.styleable.ExtendTextView_android_lines:
                setLines(a.getInt(attr, -1));
                break;

            case R.styleable.ExtendTextView_android_height:
                setHeight(a.getDimensionPixelSize(attr, -1));
                break;

            case R.styleable.ExtendTextView_android_minLines:
                setMinLines(a.getInt(attr, -1));
                break;

            case R.styleable.ExtendTextView_android_minHeight:
                setMinHeight(a.getDimensionPixelSize(attr, -1));
                break;

            case R.styleable.ExtendTextView_android_maxEms:
                setMaxEms(a.getInt(attr, -1));
                break;

            case R.styleable.ExtendTextView_android_maxWidth:
                setMaxWidth(a.getDimensionPixelSize(attr, -1));
                break;

            case R.styleable.ExtendTextView_android_ems:
                setEms(a.getInt(attr, -1));
                break;

            case R.styleable.ExtendTextView_android_width:
                setWidth(a.getDimensionPixelSize(attr, -1));
                break;

            case R.styleable.ExtendTextView_android_minEms:
                setMinEms(a.getInt(attr, -1));
                break;

            case R.styleable.ExtendTextView_android_minWidth:
                setMinWidth(a.getDimensionPixelSize(attr, -1));
                break;

            case R.styleable.ExtendTextView_android_gravity:
                setGravity(a.getInt(attr, -1));
                break;

            case R.styleable.ExtendTextView_android_hint:
                hint = a.getText(attr);
                break;

            case R.styleable.ExtendTextView_android_text:
                text = a.getText(attr);
                break;

            case R.styleable.ExtendTextView_android_scrollHorizontally:
                if (a.getBoolean(attr, false)) {
                    setHorizontallyScrolling(true);
                }
                break;

            case R.styleable.ExtendTextView_android_singleLine:
                singleLine = a.getBoolean(attr, singleLine);
                break;

            case R.styleable.ExtendTextView_android_ellipsize:
                ellipsize = a.getInt(attr, ellipsize);
                break;

            case R.styleable.ExtendTextView_android_marqueeRepeatLimit:
                setMarqueeRepeatLimit(a.getInt(attr, mMarqueeRepeatLimit));
                break;

            case R.styleable.ExtendTextView_android_includeFontPadding:
                if (!a.getBoolean(attr, true)) {
                    setIncludeFontPadding(false);
                }
                break;

            case R.styleable.ExtendTextView_android_cursorVisible:
                if (!a.getBoolean(attr, true)) {
                    setCursorVisible(false);
                }
                break;

            case R.styleable.ExtendTextView_android_maxLength:
                maxlength = a.getInt(attr, -1);
                break;

            case R.styleable.ExtendTextView_android_textScaleX:
                setTextScaleX(a.getFloat(attr, 1.0f));
                break;

            case R.styleable.ExtendTextView_android_freezesText:
                mFreezesText = a.getBoolean(attr, false);
                break;

            case R.styleable.ExtendTextView_android_shadowColor:
                shadowcolor = a.getInt(attr, 0);
                break;

            case R.styleable.ExtendTextView_android_shadowDx:
                dx = a.getFloat(attr, 0);
                break;

            case R.styleable.ExtendTextView_android_shadowDy:
                dy = a.getFloat(attr, 0);
                break;

            case R.styleable.ExtendTextView_android_shadowRadius:
                r = a.getFloat(attr, 0);
                break;

            case R.styleable.ExtendTextView_android_enabled:
                setEnabled(a.getBoolean(attr, isEnabled()));
                break;

            case R.styleable.ExtendTextView_android_textColorHighlight:
                textColorHighlight = a.getColor(attr, textColorHighlight);
                break;

            case R.styleable.ExtendTextView_android_textColor:
                textColor = a.getColorStateList(attr);
                break;

            case R.styleable.ExtendTextView_android_textColorHint:
                textColorHint = a.getColorStateList(attr);
                break;

            case R.styleable.ExtendTextView_android_textColorLink:
                textColorLink = a.getColorStateList(attr);
                break;

            case R.styleable.ExtendTextView_android_textSize:
                textSize = a.getDimensionPixelSize(attr, textSize);
                break;

            case R.styleable.ExtendTextView_android_typeface:
                typefaceIndex = a.getInt(attr, typefaceIndex);
                break;

            case R.styleable.ExtendTextView_android_textStyle:
                styleIndex = a.getInt(attr, styleIndex);
                break;

            case R.styleable.ExtendTextView_android_password:
                password = a.getBoolean(attr, password);
                break;

            case R.styleable.ExtendTextView_android_lineSpacingExtra:
                mSpacingAdd = a.getDimensionPixelSize(attr, (int) mSpacingAdd);
                break;

            case R.styleable.ExtendTextView_android_lineSpacingMultiplier:
                mSpacingMult = a.getFloat(attr, mSpacingMult);
                break;

            case R.styleable.ExtendTextView_android_inputType:
                inputType = a.getInt(attr, mInputType);
                break;

            case R.styleable.ExtendTextView_android_imeOptions:
            ...
            case R.styleable.ExtendTextView_android_imeActionLabel:
                if (mInputContentType == null) {
                    mInputContentType = new InputContentType();
                }
            ...
            case R.styleable.ExtendTextView_android_imeActionId:
                if (mInputContentType == null) {
                    mInputContentType = new InputContentType();
                }
            ...
            case R.styleable.ExtendTextView_android_privateImeOptions:
                setPrivateImeOptions(a.getString(attr));
                break;

            case R.styleable.ExtendTextView_android_editorExtras:
                try {
            ...
            case R.styleable.ExtendTextView_android_textSelectHandleLeft:
                mTextSelectHandleLeftRes = a.getResourceId(attr, 0);
                break;

            case R.styleable.ExtendTextView_android_textSelectHandleRight:
                mTextSelectHandleRightRes = a.getResourceId(attr, 0);
                break;

            case R.styleable.ExtendTextView_android_textSelectHandle:
                mTextSelectHandleRes = a.getResourceId(attr, 0);
                Log.e("1234", mTextSelectHandleRes+"");
                break;
            }
        }
        a.recycle();
        ...
        boolean focusable = (mMovement != null || mInput != null) && isFocusable();
     ...
     *
     * @attr ref android.R.styleable#ExtendExtendTextView_android_typeface
     * @attr ref android.R.styleable#ExtendExtendTextView_android_textStyle
     */
    ...
    /**
     * @return the current key listener for this ExtendTextView.
    ...
    /**
     * Sets the key listener to be used with this ExtendTextView.  This can be null
     ...
     *
     * @attr ref android.R.styleable#ExtendExtendTextView_android_numeric
     * @attr ref android.R.styleable#ExtendExtendTextView_android_digits
     * @attr ref android.R.styleable#ExtendExtendTextView_android_phoneNumber
     * @attr ref android.R.styleable#ExtendExtendTextView_android_inputMethod
     * @attr ref android.R.styleable#ExtendExtendTextView_android_capitalize
     * @attr ref android.R.styleable#ExtendExtendTextView_android_autoText
     */
    ...
    /**
     * @return the movement method being used for this ExtendTextView.
     * This will frequently be null for non-EditText TextViews.
     */
     ...
     * this ExtendTextView.  This can be null to disallow using the arrow keys
    ...
    /**
     * @return the current transformation method for this ExtendTextView.
     ...
     *
     * @attr ref android.R.styleable#ExtendExtendTextView_android_password
     * @attr ref android.R.styleable#ExtendExtendTextView_android_singleLine
     */
     ...
     *
     * @attr ref android.R.styleable#ExtendExtendTextView_android_drawableLeft
     * @attr ref android.R.styleable#ExtendExtendTextView_android_drawableTop
     * @attr ref android.R.styleable#ExtendExtendTextView_android_drawableRight
     * @attr ref android.R.styleable#ExtendExtendTextView_android_drawableBottom
     */
     ...
     * the text.
     *
     * @attr ref android.R.styleable#ExtendExtendTextView_android_drawablePadding
     */
     ...
     * possible values.
     *
     * @attr ref android.R.styleable#ExtendExtendTextView_android_autoLink
     */
    ...
    public void setTextAppearance(Context context, int resid) {
        ...
        color = appearance.getColor(R.styleable.TextAppearance_android_textColorHighlight, 0);
        if (color != 0) {
    ...
    /**
     * @return the size (in pixels) of the default text size in this ExtendTextView.
     */
     ...
     *
     * @attr ref android.R.styleable#ExtendExtendTextView_android_textSize
     */
     ...
     *
     * @attr ref android.R.styleable#ExtendExtendTextView_android_textScaleX
     */
     ...
     *
     * @attr ref android.R.styleable#ExtendExtendTextView_android_textColor
     */
     ...
     *
     * @attr ref android.R.styleable#ExtendExtendTextView_android_textColorHighlight
     */
     ...
     *
     * @attr ref android.R.styleable#ExtendExtendTextView_android_shadowColor
     * @attr ref android.R.styleable#ExtendExtendTextView_android_shadowDx
     * @attr ref android.R.styleable#ExtendExtendTextView_android_shadowDy
     * @attr ref android.R.styleable#ExtendExtendTextView_android_shadowRadius
     */
     ...
     * The default is true.
     *
     * @attr ref android.R.styleable#ExtendExtendTextView_android_linksClickable
     */
     ...
     *
     * @attr ref android.R.styleable#ExtendExtendTextView_android_textColorHint
     */
     ...
     *
     * @attr ref android.R.styleable#ExtendExtendTextView_android_textColorLink
     */
     ...
     * @attr ref android.R.styleable#ExtendExtendTextView_android_gravity
     */
    ...
    /**
     * Returns the horizontal and vertical alignment of this ExtendTextView.
     *
     * @see android.view.Gravity
     * @attr ref android.R.styleable#ExtendExtendTextView_android_gravity
     */
     ...
     *
     * @attr ref android.R.styleable#ExtendExtendTextView_android_scrollHorizontally
     */
     ...
     *
     * @attr ref android.R.styleable#ExtendExtendTextView_android_minLines
     */
     ...
     *
     * @attr ref android.R.styleable#ExtendExtendTextView_android_minHeight
     */
     ...
     *
     * @attr ref android.R.styleable#ExtendExtendTextView_android_maxLines
     */
     ...
     *
     * @attr ref android.R.styleable#ExtendExtendTextView_android_maxHeight
     */
     ...
     *
     * @attr ref android.R.styleable#ExtendExtendTextView_android_lines
     */
     ...
     * LayoutParams.
     *
     * @attr ref android.R.styleable#ExtendExtendTextView_android_height
     */
     ...
     *
     * @attr ref android.R.styleable#ExtendExtendTextView_android_minEms
     */
     ...
     *
     * @attr ref android.R.styleable#ExtendExtendTextView_android_minWidth
     */
     ...
     *
     * @attr ref android.R.styleable#ExtendExtendTextView_android_maxEms
     */
     ...
     *
     * @attr ref android.R.styleable#ExtendExtendTextView_android_maxWidth
     */
     ...
     *
     * @attr ref android.R.styleable#ExtendExtendTextView_android_ems
     */
     ...
     * LayoutParams.
     *
     * @attr ref android.R.styleable#ExtendExtendTextView_android_width
     */
    ...
    /**
     * Sets line spacing for this ExtendTextView.  Each line will have its height
     * multiplied by <code>mult</code> and have <code>add</code> added to it.
     *
     * @attr ref android.R.styleable#ExtendExtendTextView_android_lineSpacingExtra
     * @attr ref android.R.styleable#ExtendExtendTextView_android_lineSpacingMultiplier
     */
    ...
    public static class SavedState extends BaseSavedState {
        ...
        public String toString() {
            String str = "ExtendTextView.SavedState{"
     ...
     *
     * @attr ref android.R.styleable#ExtendExtendTextView_android_freezesText
     */
    ...
    /**
     * Sets the string value of the ExtendTextView. TextView <em>does not</em> accept
     ...
     *
     * @attr ref android.R.styleable#ExtendExtendTextView_android_text
     */
     ...
     *
     * @attr ref android.R.styleable#ExtendExtendTextView_android_text
     * @attr ref android.R.styleable#ExtendExtendTextView_android_bufferType
     */
    ...
    /**
     * Like {@link #setText(CharSequence, android.widget.ExtendTextView.BufferType)},
     * except that the cursor position (if any) is retained in the new text.
     *
     * @see #setText(CharSequence, android.widget.ExtendTextView.BufferType)
     */
     ...
     *
     * @attr ref android.R.styleable#ExtendExtendTextView_android_hint
     */
     ...
     * @attr ref android.R.styleable#ExtendExtendTextView_android_inputType
     */
     ...
     * @attr ref android.R.styleable#ExtendExtendTextView_android_imeOptions
     */
     ...
     * @see #getImeActionId
     * @see android.view.inputmethod.EditorInfo
     * @attr ref android.R.styleable#ExtendExtendTextView_android_imeActionLabel
     * @attr ref android.R.styleable#ExtendExtendTextView_android_imeActionId
     */
     ...
     * @attr ref android.R.styleable#ExtendExtendTextView_android_privateImeOptions
     */
     ...
     * @attr ref android.R.styleable#ExtendExtendTextView_android_editorExtras
     */
    ...
    private void showError() {
        ...
        if (mPopup == null) {
            ...
            final ExtendTextView err = (ExtendTextView) inflater.inflate(R.layout.extendtextview_hint,
                    null);
        ...
        ExtendTextView tv = (ExtendTextView) mPopup.getContentView();
    ...
    private static class ErrorPopup extends PopupWindow {
        ...
        private final ExtendTextView mView;

        ErrorPopup(ExtendTextView v, int width, int height) {
    ...
    private void chooseSize(PopupWindow pop, CharSequence text, ExtendTextView tv) {
     ...
     *
     * @attr ref android.R.styleable#ExtendExtendTextView_android_maxLength
     */
    ...
    public boolean onPreDraw() {
        ...
        if (mCreatedWithASelection ||
           (selectionController != null && hasSelection())) {
    ...
    public void invalidateDrawable(Drawable drawable) {
        if (verifyDrawable(drawable)) {
            ...
            // accordingly.
            final ExtendTextView.Drawables drawables = mDrawables;
            if (drawables != null) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (dr != null) {
            ...
            if (dr.mDrawableLeft != null) {
                canvas.save();
                canvas.translate(scrollX + getPaddingLeft(),
            ...
            if (dr.mDrawableRight != null) {
                canvas.save();
                canvas.translate(scrollX + right - left - getPaddingRight() - dr.mDrawableSizeRight,
            ...
            if (dr.mDrawableBottom != null) {
                ...
                canvas.translate(scrollX + compoundPaddingLeft +
                        (hspace - dr.mDrawableWidthBottom) / 2,
                         scrollY + bottom - top - getPaddingBottom() - dr.mDrawableSizeBottom);
        ...
        */
        ...
        if (mEllipsize == TextUtils.TruncateAt.MARQUEE) {
            if (!mSingleLine && getLineCount() == 1 && canMarquee() &&
                ...
                canvas.translate(mLayout.getLineRight(0) - (getRight() - getLeft() -
    ...
    public void setExtractedText(ExtractedText text) {
        ...
        if (text.text != null) {
            if (content == null) {
                setText(text.text, ExtendTextView.BufferType.EDITABLE);
     ...
     * The default is true.
     *
     * @attr ref android.R.styleable#ExtendExtendTextView_android_includeFontPadding
     */
     ...
     *
     * @attr ref android.R.styleable#ExtendExtendTextView_android_ellipsize
     */
     ...
     *
     * @attr ref android.R.styleable#ExtendExtendTextView_android_marqueeRepeatLimit
     */
     ...
     * selected.
     *
     * @attr ref android.R.styleable#ExtendExtendTextView_android_selectAllOnFocus
     */
     ...
     *
     * @attr ref android.R.styleable#ExtendExtendTextView_android_cursorVisible
     */
    ...
    private static final class Marquee extends Handler {
        ...
        private final WeakReference<ExtendTextView> mView;
        ...
        void tick() {
            ...
            final ExtendTextView textView = mView.get();
    ...
    implements TextWatcher, SpanWatcher {
        ...
        public void beforeTextChanged(CharSequence buffer, int start,
            ...
            ExtendTextView.this.sendBeforeTextChanged(buffer, start, before, after);
        }
        ...
        public void onTextChanged(CharSequence buffer, int start,
            ...
            if (DEBUG_EXTRACT) Log.v(LOG_TAG, "onTextChanged start=" + start
                    + " before=" + before + " after=" + after + ": " + buffer);
            ExtendTextView.this.handleTextChanged(buffer, start, before, after);
        }

        public void afterTextChanged(Editable buffer) {
            if (DEBUG_EXTRACT) Log.v(LOG_TAG, "afterTextChanged: " + buffer);
            ExtendTextView.this.sendAfterTextChanged(buffer);
        }
        ...
        public void onSpanChanged(Spannable buf,
            ...
            ExtendTextView.this.spanChange(buf, what, s, st, e, en);
        }

        public void onSpanAdded(Spannable buf, Object what, int s, int e) {
            if (DEBUG_EXTRACT) Log.v(LOG_TAG, "onSpanAdded s=" + s + " e=" + e
                    + " what=" + what + ": " + buf);
            ExtendTextView.this.spanChange(buf, what, -1, s, -1, e);
            requestLayout();
            if (what instanceof ViewSpan && ((ViewSpan) what).getView().getParent() == null) {
            	ExtendTextView.this.addView(((ViewSpan) what).getView());
            }
        }
        ...
        public void onSpanRemoved(Spannable buf, Object what, int s, int e) {
            if (DEBUG_EXTRACT) Log.v(LOG_TAG, "onSpanRemoved s=" + s + " e=" + e
                    + " what=" + what + ": " + buf);
            ExtendTextView.this.spanChange(buf, what, s, -1, e, -1);
            if (what instanceof ViewSpan && ((ViewSpan) what).getView().getParent() != null) {
            	ExtendTextView.this.removeView(((ViewSpan) what).getView());
            }
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if ((mMovement != null || onCheckIsTextEditor()) && mText instanceof Spannable && mLayout != null) {
            ...
            if (isTextEditable()) {
                if (getScrollX() != oldScrollX || getScrollY() != oldScrollY) {
    ...
    /**
     * Returns the ExtendExtendTextView_android_textColor attribute from the
     * Resources.StyledAttributes, if set, or the TextAppearance_android_textColor
     * from the ExtendExtendTextView_android_textAppearance attribute, if ExtendExtendTextView_android_textColor
     * was not set directly.
     */
    public static ColorStateList getTextColors(Context context, TypedArray attrs) {
        ColorStateList colors;
        colors = attrs.getColorStateList(R.styleable.
                                         ExtendTextView_android_textColor);

        if (colors == null) {
            int ap = attrs.getResourceId(R.styleable.
                                         ExtendTextView_android_textAppearance, -1);
            if (ap != -1) {
                TypedArray appearance;
                appearance = context.obtainStyledAttributes(ap,
                                            R.styleable.TextAppearance);
    ...
    /**
     * Returns the default color from the ExtendExtendTextView_android_textColor attribute
     * from the AttributeSet, if set, or the default color from the
     * TextAppearance_android_textColor from the ExtendExtendTextView_android_textAppearance attribute,
     * if ExtendExtendTextView_android_textColor was not set directly.
     */
    ...
    protected void onCreateContextMenu(ContextMenu menu) {
        ...
        if (mIsInTextSelectionMode) {
            ...
            if (canCut()) {
                menu.add(0, ID_CUT, 0, R.string.cut).
            ...
            if (canSelectText()) {
                ...
                menu.add(0, ID_SELECT_ALL, 0, R.string.selectAll).
                     setOnMenuItemClickListener(handler).
            ...
            if (mText instanceof Spanned) {
                ...
                URLSpan[] urls = ((Spanned) mText).getSpans(min, max,
                        URLSpan.class);
                if (urls.length == 1) {
                    menu.add(0, ID_COPY_URL, 0, R.string.copyUrl).
                         setOnMenuItemClickListener(handler);
                    added = true;
                }
            }
    ...
    private class HandleView extends View {
        ...
        public HandleView(CursorController controller, int pos) {
            super(ExtendTextView.this.getContext());
            mController = controller;
            mContainer = new PopupWindow(ExtendTextView.this.getContext(), null,
        ...
        public void show() {
            ...
            ExtendTextView.this.getLocationInWindow(coords);
            coords[0] += mPositionX;
            coords[1] += mPositionY;
            mContainer.showAtLocation(ExtendTextView.this, 0, coords[0], coords[1]);
        }
        ...
        private boolean isPositionVisible() {
            ...
            final ExtendTextView hostView = ExtendTextView.this;
            final int left = 0;
        ...
        private void moveTo(int x, int y) {
            mPositionX = x - ExtendTextView.this.getScrollX();
            mPositionY = y - ExtendTextView.this.getScrollY();
            if (isPositionVisible()) {
                int[] coords = null;
        ...
        public void onDraw(Canvas c) {
            ...
            if (mPositionOnTop) {
                c.save();
                c.rotate(180, (getRight() - getLeft()) / 2, (getBottom() - getTop()) / 2);
                mDrawable.draw(c);
                c.restore();
            } else {
                mDrawable.draw(c);
        ...
        void positionAtCursor(final int offset, boolean bottom) {
            ...
            bounds.left = (int) (mLayout.getPrimaryHorizontal(offset) - mHotspotX)
                + ExtendTextView.this.getScrollX();
            bounds.top = (bottom ? lineBottom : lineTop - mHeight) + ExtendTextView.this.getScrollY();
