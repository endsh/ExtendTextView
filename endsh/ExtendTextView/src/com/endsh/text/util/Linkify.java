...
public class Linkify {
    ...
    /**
     *  Scans the text of the provided ExtendTextView and turns all occurrences of
     *  the link types indicated in the mask into clickable links.  If matches
     *  are found the movement method for the ExtendTextView is set to
     *  LinkMovementMethod.
     */
    public static final boolean addLinks(ExtendTextView text, int mask) {
        if (mask == 0) {
            return false;
        }
    ...
    private static final void addLinkMovementMethod(ExtendTextView t) {
    ...
    /**
     *  Applies a regex to the text of a ExtendTextView turning the matches into
     *  links.  If links are found then UrlSpans are applied to the link
     *  text match areas, and the movement method for the text is changed
     *  to LinkMovementMethod.
     *
     *  @param text         ExtendTextView whose text is to be marked-up with links
     *  @param pattern      Regex pattern to be used for finding links
     *  @param scheme       Url scheme string (eg <code>http://</code> to be
     *                      prepended to the url of links that do not have
     *                      a scheme specified in the link text
     */
    public static final void addLinks(ExtendTextView text, Pattern pattern, String scheme) {
     ...
     */
    public static final void addLinks(ExtendTextView text, Pattern p, String scheme,
