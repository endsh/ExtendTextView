    ...
    public SpannableStringBuilder replace(final int start, final int end,
        ...
        if (adjustSelection) {
            if (selectionStart > start && selectionStart < end) {
                ...
                setSpan(false, android.text.Selection.SELECTION_START, selectionStart, selectionStart,
            ...
            if (selectionEnd > start && selectionEnd < end) {
                ...
                setSpan(false, android.text.Selection.SELECTION_END, selectionEnd, selectionEnd,
                        Spanned.SPAN_POINT_POINT);
            }
        }
