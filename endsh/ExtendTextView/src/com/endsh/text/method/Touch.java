...
import com.endsh.text.Layout.Alignment;
...
public class Touch {
     ...
     * Y position.
     */
    public static void scrollTo(ExtendTextView widget, Layout layout, int x, int y) {
     ...
     */
    public static int getMaxScrollX(ExtendTextView widget, Layout layout, int y) {
        int top = layout.getLineForVertical(y);
        int bottom = layout.getLineForVertical(y + widget.getHeight()
     ...
     */
    public static boolean onTouchEvent(ExtendTextView widget, Spannable buffer,
                                       MotionEvent event) {
        DragState[] ds;
    ...
    public static int getInitialScrollX(ExtendTextView widget, Spannable buffer) {
        DragState[] ds = buffer.getSpans(0, buffer.length(), DragState.class);
        return ds.length > 0 ? ds[0].mScrollX : -1;
    }
    
    public static int getInitialScrollY(ExtendTextView widget, Spannable buffer) {
        DragState[] ds = buffer.getSpans(0, buffer.length(), DragState.class);
