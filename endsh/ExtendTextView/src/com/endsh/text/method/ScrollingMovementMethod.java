...
implements MovementMethod
{
     ...
     */
    protected boolean left(ExtendTextView widget, Spannable buffer) {
     ...
     */
    protected boolean right(ExtendTextView widget, Spannable buffer) {
        Layout layout = widget.getLayout();
     ...
     */
    protected boolean up(ExtendTextView widget, Spannable buffer) {
        Layout layout = widget.getLayout();
     ...
     */
    protected boolean down(ExtendTextView widget, Spannable buffer) {
        Layout layout = widget.getLayout();
    ...
    public boolean onTrackballEvent(ExtendTextView widget, Spannable text,
            MotionEvent event) {
        return false;
    }
    
    public boolean onTouchEvent(ExtendTextView widget, Spannable buffer,
                                 MotionEvent event) {
    ...
    public void onTakeFocus(ExtendTextView widget, Spannable text, int dir) {
        Layout layout = widget.getLayout();
