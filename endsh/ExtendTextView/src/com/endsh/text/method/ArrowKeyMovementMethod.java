...
public class ArrowKeyMovementMethod implements MovementMethod {
    ...
    private boolean up(ExtendTextView widget, Spannable buffer) {
    ...
    private boolean down(ExtendTextView widget, Spannable buffer) {
        boolean cap = isCap(buffer);
        boolean alt = isAlt(buffer);
        Layout layout = widget.getLayout();
    ...
    private boolean left(ExtendTextView widget, Spannable buffer) {
        boolean cap = isCap(buffer);
        boolean alt = isAlt(buffer);
        Layout layout = widget.getLayout();
    ...
    private boolean right(ExtendTextView widget, Spannable buffer) {
        boolean cap = isCap(buffer);
        boolean alt = isAlt(buffer);
        Layout layout = widget.getLayout();
    ...
    public boolean onKeyDown(ExtendTextView widget, Spannable buffer, int keyCode, KeyEvent event) {
    ...
    private boolean executeDown(ExtendTextView widget, Spannable buffer, int keyCode) {
    ...
    public boolean onKeyUp(ExtendTextView widget, Spannable buffer, int keyCode, KeyEvent event) {
        return false;
    }

    public boolean onKeyOther(ExtendTextView view, Spannable text, KeyEvent event) {
    ...
    public boolean onTrackballEvent(ExtendTextView widget, Spannable text, MotionEvent event) {
        return false;
    }

    public boolean onTouchEvent(ExtendTextView widget, Spannable buffer, MotionEvent event) {
    ...
    public void initialize(ExtendTextView widget, Spannable text) {
        Selection.setSelection(text, 0);
    }

    public void onTakeFocus(ExtendTextView view, Spannable text, int dir) {
